    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-secondary-600 mt-2">Track your performance across all connected platforms</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { title: 'Total Followers', value: formatNumber(aggregated?.totalFollowers || 0), change: '+12%', icon: Users, color: 'from-primary-600 to-primary-700' },
          { title: 'Engagement Rate', value: `${(aggregated?.avgEngagementRate || 0).toFixed(1)}%`, change: '+0.4%', icon: TrendingUp, color: 'from-green-500 to-emerald-600' },
          { title: 'Total Reach', value: formatNumber(aggregated?.totalReach || 0), change: '+18%', icon: Eye, color: 'from-blue-500 to-cyan-600' },
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 border border-secondary-200 rounded-lg">
                ...
                <p className="text-sm text-secondary-600">Videos get 3x more engagement</p>
              </div>
              <div className="p-4 border border-secondary-200 rounded-lg">
